-- 0113: Grammar Battle scoring and tier progression fix
-- Fixes: correct_answers × 5 points (max 50), server-authoritative 10/10 → advance one tier
-- Removes: Academy level A/B/C changes (not explicitly linked to Grammar Battle)
-- Works whether 0112 was already applied (create or replace)
