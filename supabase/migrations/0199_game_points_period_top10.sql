-- Migration 0199: cap daily and weekly Game Points leaderboards at Top 10.
-- Monthly and all_time keep the existing unbounded behavior.
-- Replaces get_game_points_period_leaderboard from 0198 with the same
-- signature, security, and search_path; only adds a conditional LIMIT.
