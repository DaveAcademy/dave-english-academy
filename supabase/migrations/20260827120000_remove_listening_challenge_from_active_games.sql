-- Remove Listening Challenge from active game types in submit_game_round
-- Listening Challenge was replaced by Hangman (2026-08-19) and is no longer
-- an active playable game in the Game Center. It remains in the database for
-- historical session data but should not be accepted as a valid game_type
-- for new round submissions.
