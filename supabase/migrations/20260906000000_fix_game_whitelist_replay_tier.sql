-- Fix: Restore 10-game whitelist + replay protection + 10/10 tier advancement
-- Previous 20260903000000 broke whitelist (only 3 games) and replay (gen_random_uuid instead of p_round_id)
-- This restores definitive 20260827223000 logic with universal core tier rule: exactly 10/10 -> +1 tier
-- Scoring remains server-authoritative (10pts per correct, 5 hint, speed bonus), no client trust
