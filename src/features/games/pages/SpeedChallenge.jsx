    ...
    return (
      <div className="animate-[fadeIn_0.3s_ease-out] mx-auto max-w-sm">
        <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-rose-50 to-orange-100 p-6 text-center shadow-card sm:p-8">
          <span className="animate-[bounceIn_0.4s_ease-out] inline-block">
          ...
          <div className="animate-[scaleIn_0.3s_ease-out_0.15s_both] mt-4">
  ...
  if (error) {
    ...
    return (
      <div className="rounded-2xl bg-white p-10 text-center shadow-card">
        ...
        <button
          onClick={() => (isSubmitError ? finishRound(lastAnswersRef.current) : startRound())}
          disabled={submitting}
