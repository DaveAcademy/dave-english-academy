            ...
            >
              <Link to={`/lessons/${l.id}`} className="min-w-0 flex-1" title="Open Lesson Hub">
                ...
                <div className="mt-1 flex flex-wrap items-center gap-2 text-xs opacity-80">
                  ...
                  {l.pdf_path ? (
                    <span className="rounded-full bg-active/20 px-1.5 py-0.5 text-[10px] font-bold">=ÉÙ‰ PDF attached</span>
                  ) : (
                    <span className="rounded-full bg-inactive/20 px-1.5 py-0.5 text-[10px] font-bold">G‹·n+≈ No PDF</span>
                  )}
                  <span className="rounded-full bg-ink/10 px-1.5 py-0.5 text-[10px] font-bold">=ÉÙ‹ {l.vocabulary_count} words</span>
                </div>
              </Link>
